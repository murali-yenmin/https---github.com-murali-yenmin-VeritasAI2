    ...
    <div className="flex flex-col min-h-dvh bg-background">
      <header className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <div className="flex justify-center items-center gap-4 border-b-2 border-grey pb-6">
           ...
           <h1 className="text-4xl sm:text-5xl md:text-6xl font-headline font-bold text-primary tracking-tight mt-8">
              AI or Human?
            </h1>
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 mt-auto">
        <div className="max-w-5xl mx-auto text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} AiDentify. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
